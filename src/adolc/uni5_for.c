/*----------------------------------------------------------------------------
 ...
 File:     uni5_for.mc
 Revision: $Id: uni5_for.c 134 2009-03-03 14:25:24Z imosqueira $
...
#define T0arg  T0temp
    ...
    case min_op:                                                /* min_op */
...
#endif /* ALL_TOGETHER_AGAIN */
            T0[res] = MIN_ADOLC(T0[arg1], T0[arg2]);
            break;
        ...
        case assign_depvec:                                  /* assign_depvec */
            ...
            for (ls=0; ls<size; ls++) { /* code for assign_dep */
